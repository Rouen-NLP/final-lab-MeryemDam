...
accuracy = train_model(MultinomialNB(), xtrain_count, y_train, xval_count)
print ("NB, Count Vectors: ", accuracy)

#%%
# NB on Word Level TF IDF Vectors
accuracy = train_model(MultinomialNB(), xtrain_tfidf, y_train, xval_tfidf)
print ("NB, WordLevel TF-IDF: ", accuracy)

#%%
# Linear Classifier on Ngram Level TF IDF Vectors
accuracy = train_model(MultinomialNB(), xtrain_tfidf_ngram, y_train, xval_tfidf_ngram)
print ("NB, N-Gram Vectors: ", accuracy)

#%%
# Linear Classifier on Character Level TF IDF Vectors
accuracy = train_model(MultinomialNB(), xtrain_tfidf_ngram_chars, y_train, xval_tfidf_ngram_chars)
