...
print ("LR, Count Vectors: ", accuracy_linear_count)
#%%
...
print ("MLP, WordLevel TF-IDF: ", accuracy_mlp_word)
...
print ("MLP, N-Gram Vectors: ", accuracy_mlp_ngram)
...
print ("MLP, CharLevel Vectors: ", accuracy_mlp_character)
        
#%%Final Results
final_result = pd.DataFrame(columns = ["Linear Classifier", "Naive Bayes", "MLP"])
final_result.at[0,"Linear Classifier"] = accuracy_linear_count
final_result.at[0,"Naive Bayes"] = accuracy_nb_count
final_result.at[0,"MLP"] = accuracy_mlp_count

final_result.at[1,"Linear Classifier"] = accuracy_linear_word
final_result.at[1,"Naive Bayes"] =accuracy_nb_word
final_result.at[1,"MLP"] = accuracy_mlp_word

final_result.at[2,"Linear Classifier"] = accuracy_linear_ngram
final_result.at[2,"Naive Bayes"] =accuracy_nb_ngram
final_result.at[2,"MLP"] = accuracy_mlp_ngram

final_result.at[3,"Linear Classifier"] = accuracy_linear_character
final_result.at[3,"Naive Bayes"] =accuracy_nb_character
final_result.at[3,"MLP"] = accuracy_mlp_character
